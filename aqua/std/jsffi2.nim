...
{.experimental.}
macro `get`*(obj: JsObject, field: untyped): JsObject =
...
macro `set`*(obj: JsObject, field, value: untyped): untyped =
...
macro `get`*[K: cstring, V](obj: JsAssoc[K, V],
                                   field: untyped): V =
...
macro `set`*[K: cstring, V](obj: JsAssoc[K, V],
                                    field: untyped,
                                    value: V): untyped =
...
macro `call`*[K: cstring, V: proc](obj: JsAssoc[K, V],
                                           field: untyped,
